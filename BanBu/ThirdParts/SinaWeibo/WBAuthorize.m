...
- (void)startAuthorize
{
    ...
    WBAuthorizeWebViewController *authorizeWebViewController = [[WBAuthorizeWebViewController alloc] init];
    [authorizeWebViewController setDelegate:self];
    [authorizeWebViewController loadRequestWithURL:[NSURL URLWithString:urlString]];
   // UINavigationController *nav = [[[UINavigationController alloc] initWithRootViewController:authorizeWebViewController] autorelease];
    BanBu_NavigationController *nav = [[[BanBu_NavigationController alloc] initWithRootViewController:authorizeWebViewController] autorelease];
    [rootViewController presentModalViewController:nav animated:YES];
    [authorizeWebViewController release];
}
...
- (void)authorizeWebView:(WBAuthorizeWebViewController *)controller didReceiveAuthorizeCode:(NSString *)code;
{
